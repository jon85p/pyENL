...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        self.solve_button.setText(_translate("MainWindow", "Resolver", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.eqnTab), _translate("MainWindow", "Ecuaciones", None))
        self.Actualizar_Button.setText(_translate("MainWindow", "Actualizar", None))
        self.cleanVarButton.setText(_translate("MainWindow", "Limpiar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.varTab), _translate("MainWindow", "Variables", None))
        self.info_button.setText(_translate("MainWindow", "Información", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.solTab), _translate("MainWindow", "Soluciones", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.resTab), _translate("MainWindow", "Residuos", None))
        self.infoLabel.setText(_translate("MainWindow", "x Ecuaciones/y Variables", None))
        self.menuArchivo.setTitle(_translate("MainWindow", "Archivo", None))
        self.menuExportar_reporte.setTitle(_translate("MainWindow", "Exportar reporte", None))
        self.menuImportar.setTitle(_translate("MainWindow", "Importar", None))
        ...
        self.menuFunciones_Ingenieria.setTitle(_translate("MainWindow", "Funciones Ingeniería", None))
        self.menuFunciones_de_usuario.setTitle(_translate("MainWindow", "Funciones de usuario", None))
        ...
        self.actionComentario.setText(_translate("MainWindow", "Comentario", None))
        self.actionSeleccionar_todo.setText(_translate("MainWindow", "Seleccionar todo", None))
        self.actionDeshacer.setText(_translate("MainWindow", "Deshacer", None))
        self.actionRehacer.setText(_translate("MainWindow", "Rehacer", None))
        self.actionCopiar.setText(_translate("MainWindow", "Copiar", None))
        self.actionPegar.setText(_translate("MainWindow", "Cortar", None))
        self.actionPegar_2.setText(_translate("MainWindow", "Pegar", None))
        self.actionAyuda_pyENL.setText(_translate("MainWindow", "Ayuda pyENL", None))
        self.actionAyuda_NumPy.setText(_translate("MainWindow", "Ayuda NumPy", None))
        self.actionAyuda_CoolProp.setText(_translate("MainWindow", "Ayuda CoolProp", None))
        self.actionSobre_pyENL.setText(_translate("MainWindow", "Sobre pyENL", None))
        self.actionLicencias.setText(_translate("MainWindow", "Licencias", None))
        self.actionTermodinamicas.setText(_translate("MainWindow", "Termodinámicas", None))
        self.actionPor_agregar.setText(_translate("MainWindow", "Por agregar...", None))
        self.actionDisponibles.setText(_translate("MainWindow", "Disponibles", None))
        self.actionAgregar.setText(_translate("MainWindow", "Agregar...", None))
        self.actionUnidades.setText(_translate("MainWindow", "Unidades", None))
        ...
        self.actionLibreOffice.setText(_translate("MainWindow", "Open Document Text", None))
        self.actionTeX.setText(_translate("MainWindow", "Archivo LaTeX", None))
        self.actionArchivo_EES.setText(_translate("MainWindow", "Archivo EES", None))
