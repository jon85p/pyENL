...
class Ui_Dialog(object):
    def setupUi(self, Dialog, traduccion):
        ...
        self.widget.setGeometry(QtCore.QRect(7, 7, 203, 120))
        ...
        self.format_line = QtWidgets.QLineEdit(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 20, 247, 182))
        ...
        self.method_opt = QtWidgets.QComboBox(self.widget1)
